                    ...
                    <div class="row">
                        <div class="col-sm-6">
							...
							<div class="row">
								...
								<div class="col-lg-4 col-md-5">
									<div class="form-group">
                                        <label class="control-label"><?php __('lblProductStatus'); ?></label>
							                ...
							                <div class="switch onoffswitch-data pull-left">
							                    <div class="onoffswitch">
							                        ...
							                        <label class="onoffswitch-label" for="status">
							                            <span class="onoffswitch-inner" data-on="<?php __('product_statues_ARRAY_T', false, true)?>" data-off="<?php __('product_statues_ARRAY_F', false, true)?>"></span>
							                            <span class="onoffswitch-switch"></span>
							                        </label>
							                    </div>
							                </div>
