				...
				if($tpl['status'] == 'OK')
				{
					...
					<div class="row fdButtonContainer">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-right">
							<button data-loading-text="Loading..." class="btn btn-default text-uppercase fdButtonConfirm<?php echo ($tpl['cart_box']['cart'] !== false && count($tpl['cart_box']['cart'])) > 0 ? null : ' fdButtonDisabled';?>"><?php __('front_button_confirm');?></button>
