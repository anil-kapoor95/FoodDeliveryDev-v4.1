			...
			<div class="panel-body  pjFdPanelBody">
				<form id="fdProfileForm_<?php echo $index;?>" action="" method="post" class="form-horizontal" data-toggle="validator">
					...
					<div class="form-group">
						...
						<div class="col-lg-9 col-md-8 col-sm-8">
							<textarea name="c_notes" class="form-control" style="height: 120px;" data-msg-required="<?php __('front_notes_required');?>"><?php echo isset($CLIENT['c_notes']) ? htmlspecialchars(stripslashes(@$CLIENT['c_notes'])) : NULL; ?></textarea>
							<div class="help-block with-errors"><ul class="list-unstyled"></ul></div>
						</div>
					</div><!-- /.form-group -->
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-lg-9 col-md-8 col-sm-8">
							<select name="c_country" class="form-control" data-msg-required="<?php __('front_country_required');?>">
								...
								{
									?><option value="<?php echo $country['id']; ?>"<?php echo isset($CLIENT['c_country']) ? (@$CLIENT['c_country'] == $country['id'] ? ' selected="selected"' : NULL) : NULL; ?>><?php echo stripslashes($country['country_title']); ?></option><?php
								}
								?>
							</select>
							<div class="help-block with-errors"><ul class="list-unstyled"></ul></div>
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-9">
							<button type="submit" class="btn btn-default text-uppercase"><?php __('front_button_save');?></button>
