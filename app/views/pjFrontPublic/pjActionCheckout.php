					...
					<form id="fdCheckoutForm_<?php echo $index;?>" action="" method="post" class="form-horizontal" data-toggle="validator">
						...
						{ 
							...
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-8 col-sm-8">
									<input type="text" name="c_address_1" class="form-control<?php echo (int) $tpl['option_arr']['o_bf_include_address_1'] === 3 ? ' required' : NULL; ?>" value="<?php echo isset($FORM['c_address_1']) ? pjSanitize::html(@$FORM['c_address_1']) : pjSanitize::html(@$CLIENT['c_address_1']); ?>" data-err="<?php __('front_address1_required');?>"/>
						...
						{ 
							...
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-8 col-sm-8">
									<input type="text" name="c_address_2" class="form-control<?php echo (int) $tpl['option_arr']['o_bf_include_address_2'] === 3 ? ' required' : NULL; ?>" value="<?php echo isset($FORM['c_address_2']) ? pjSanitize::html(@$FORM['c_address_2']) : pjSanitize::html(@$CLIENT['c_address_2']); ?>" data-err="<?php __('front_address2_required');?>"/>
									<div class="help-block with-errors"><ul class="list-unstyled"></ul></div>
								</div>
							</div><!-- /.form-group -->
							<?php
						...
						{ 
							...
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-8 col-sm-8">
									<input type="text" name="c_city" class="form-control<?php echo (int) $tpl['option_arr']['o_bf_include_city'] === 3 ? ' required' : NULL; ?>" value="<?php echo isset($FORM['c_city']) ? pjSanitize::html(@$FORM['c_city']) : pjSanitize::html(@$CLIENT['c_city']); ?>" data-err="<?php __('front_city_required');?>"/>
									<div class="help-block with-errors"><ul class="list-unstyled"></ul></div>
								</div>
							</div><!-- /.form-group -->
							<?php
						...
						{ 
							...
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-8 col-sm-8">
									<input type="text" name="c_state" class="form-control<?php echo (int) $tpl['option_arr']['o_bf_include_state'] === 3 ? ' required' : NULL; ?>" value="<?php echo isset($FORM['c_state']) ? pjSanitize::html(@$FORM['c_state']) : pjSanitize::html(@$CLIENT['c_state']); ?>" data-err="<?php __('front_state_required');?>"/>
									<div class="help-block with-errors"><ul class="list-unstyled"></ul></div>
								</div>
							</div><!-- /.form-group -->
							<?php
						...
						{ 
							...
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-8 col-sm-8">
									<input type="text" name="c_zip" class="form-control<?php echo (int) $tpl['option_arr']['o_bf_include_zip'] === 3 ? ' required' : NULL; ?>" value="<?php echo isset($FORM['c_zip']) ? pjSanitize::html(@$FORM['c_zip']) : pjSanitize::html(@$CLIENT['c_zip']); ?>" data-err="<?php __('front_zip_required');?>"/>
									<div class="help-block with-errors"><ul class="list-unstyled"></ul></div>
								</div>
							</div><!-- /.form-group -->
							<?php
							...
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-8 col-sm-8">
									<select name="c_country" class="form-control<?php echo (int) $tpl['option_arr']['o_bf_include_country'] === 3 ? ' required' : NULL; ?>" data-err="<?php __('front_country_required');?>">
										...
										{
										    ?><option value="<?php echo $country['id']; ?>"<?php echo isset($FORM['c_country']) ? (@$FORM['c_country'] == $country['id'] ? ' selected="selected"' : NULL) : (@$CLIENT['c_country'] == $country['id'] ? ' selected="selected"' : NULL); ?>><?php echo pjSanitize::html($country['country_title']); ?></option><?php
										}
										?>
									</select>
									<div class="help-block with-errors"><ul class="list-unstyled"></ul></div>
						...
						if (in_array($tpl['option_arr']['o_bf_include_name'], array(2, 3)))
						{
							...
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-8 col-sm-8">
									<input type="text" name="c_name" class="form-control<?php echo (int) $tpl['option_arr']['o_bf_include_name'] === 3 ? ' required' : NULL; ?>" value="<?php echo isset($FORM['c_name']) ? pjSanitize::html(@$FORM['c_name']) : pjSanitize::html(@$CLIENT['name']); ?>" data-err="<?php __('front_name_required');?>"/>
									<div class="help-block with-errors"><ul class="list-unstyled"></ul></div>
								</div>
							</div><!-- /.form-group -->
							<?php
						...
						if (in_array($tpl['option_arr']['o_bf_include_email'], array(2, 3)))
						{
							...
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-8 col-sm-8">
									<input type="text" name="c_email" class="form-control email<?php echo (int) $tpl['option_arr']['o_bf_include_email'] === 3 ? ' required' : NULL; ?>" value="<?php echo isset($FORM['c_email']) ? pjSanitize::html(@$FORM['c_email']) : pjSanitize::html(@$CLIENT['email']); ?>" data-err="<?php __('front_email_required');?>" data-email="<?php __('front_email_not_valid');?>"/>
									<div class="help-block with-errors"><ul class="list-unstyled"></ul></div>
								</div>
							</div><!-- /.form-group -->
							<?php
						...
						{ 
							...
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-8 col-sm-8">
									<input type="text" name="c_phone" class="form-control fdW50p<?php echo (int) $tpl['option_arr']['o_bf_include_phone'] === 3 ? ' required' : NULL; ?>" value="<?php echo isset($FORM['c_phone']) ? pjSanitize::html(@$FORM['c_phone']) : pjSanitize::html(@$CLIENT['phone']); ?>" data-err="<?php __('front_phone_required');?>"/>
									<div class="help-block with-errors"><ul class="list-unstyled"></ul></div>
								</div>
							</div><!-- /.form-group -->
							<?php
						...
						{ 
							...
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-8 col-sm-8">
									<input type="text" name="c_company" class="form-control fdW100p<?php echo (int) $tpl['option_arr']['o_bf_include_company'] === 3 ? ' required' : NULL; ?>" value="<?php echo isset($FORM['c_company']) ? pjSanitize::html(@$FORM['c_company']) : pjSanitize::html(@$CLIENT['c_company']); ?>" data-err="<?php __('front_company_required');?>"/>
									<div class="help-block with-errors"><ul class="list-unstyled"></ul></div>
								</div>
							</div><!-- /.form-group -->
							<?php
						...
						{ 
							...
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-8 col-sm-8">
									<textarea name="c_notes" class="form-control<?php echo (int) $tpl['option_arr']['o_bf_include_notes'] === 3 ? ' required' : NULL; ?>" data-err="<?php __('front_notes_required');?>"><?php echo isset($FORM['c_notes']) && !empty($FORM['c_notes']) ? htmlspecialchars(stripslashes($FORM['c_notes'])) : (isset($CLIENT['c_notes']) && !empty($CLIENT['c_notes']) ? htmlspecialchars(stripslashes($CLIENT['c_notes'])) : ''); ?></textarea>
									<div class="help-block with-errors"><ul class="list-unstyled"></ul></div>
								</div>
							</div><!-- /.form-group -->
							<?php
								...
								<div class="col-lg-9 col-md-8 col-sm-8">
									<div class="checkbox">
									    <label>
									      	...
									      	<?php __('front_agree');?>&nbsp;<a href="#" data-pj-target="#pjFdTermsAndConditions" data-pj-toggle="modal"><?php __('front_terms_conditions');?></a>
									    </label>
								  	</div>
								  	<div class="help-block with-errors"><ul class="list-unstyled"></ul></div>
								</div>
