							...
							<div class="panel panel-default">
								<div class="panel-heading pjFdAccourdionOuterHead" role="tab" id="heading<?php echo $v['id']?>">
									<h1 class="panel-title text-uppercase">
										<a id="pjFdCategory_<?php echo $v['id'];?>" class="pjFdProductsType<?php echo $k==0 ? null : ' collapsed';?>" data-cid="<?php echo $v['id'];?>" data-pj-toggle="collapse" data-pj-parent="#pjFdAccordion_<?php echo $index;?>" href="#collapse<?php echo $v['id']?>" aria-expanded="<?php echo $k==0 ? 'true' : 'false';?>" aria-controls="collapse<?php echo $v['id']?>">
											<div class="row">
