<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12">
        ...
        <p class="m-b-none"><i class="fa fa-info-circle"></i><?php __('infoTermsDesc');?></p>
    </div><!-- /.col-md-12 -->
</div>
...
<div class="wrapper wrapper-content animated fadeInRight">
	...
	if (!empty($error_code))
	{
	    ...
	    switch (true)
	    {
	        case in_array($error_code, array('AO05')):
	            ?>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form id="frmUpdateOptions" action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminOptions&amp;action=pjActionUpdate" class="form-horizontal" method="post">
                        ...
                        <input type="hidden" name="value-enum-o_terms_show" value="1|0::<?php echo (int) $tpl['option_arr']['o_terms_show']; ?>">

                        <div class="row">
                            <div class="col-lg-11">
                            	<div class="form-group">
                            		<label class="col-lg-3 col-md-4 control-label"><?php __('opt_o_terms_show') ?></label>
                            		<div class="col-lg-9 col-md-8">
                            			<div class="clearfix">
							                <div class="switch onoffswitch-data pull-left">
							                    <div class="onoffswitch">
							                        <input type="checkbox" class="onoffswitch-checkbox" id="o_terms_show" name="o_terms_show"<?php echo $tpl['option_arr']['o_terms_show'] ? ' checked' : NULL; ?>>
							                        <label class="onoffswitch-label" for="o_terms_show">
                                ...
                                <div class="form-group boxTerms<?php echo $tpl['option_arr']['o_terms_show'] ? NULL : ' hidden'; ?>">
                                    <label class="col-lg-3 col-md-4 control-label"><?php __('opt_o_terms') ?></label>
                                    ...
                                    <div class="col-lg-9 col-md-8 mce-md">
                                        ...
                                        foreach ($tpl['lp_arr'] as $v)
                                        {
                                            ...
                                            <div class="<?php echo $tpl['is_flag_ready'] ? 'input-group ' : NULL;?>pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : 'table'; ?>">
                                                <textarea name="i18n[<?php echo $v['id']; ?>][o_terms]" class="form-control mceEditor" style="width: 400px; height: 260px;"><?php echo isset($tpl['arr']['i18n'][$v['id']]['o_terms']) && !empty($tpl['arr']['i18n'][$v['id']]['o_terms']) ? htmlspecialchars(stripslashes($tpl['arr']['i18n'][$v['id']]['o_terms'])) : ''; ?></textarea>
                                                <?php if ($tpl['is_flag_ready']) : ?>
