	...
	<div class="col-sm-12">
		<div class="row">
			<div class="col-lg-9 col-md-8 col-sm-6">
				<h2><?php __('infoReminderTitle');?></h2>
			</div>
		...
		<p class="m-b-none"><i class="fa fa-info-circle"></i><?php __('infoReminderDesc');?></p>
	</div><!-- /.col-md-12 -->
</div>
					...
					<form id="frmReminder" action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminOptions&amp;action=pjActionUpdate" class="form-horizontal" method="post">
						...
						<div class="row">
							<div class="col-lg-8">
								<div class="form-group">
									<label class="col-lg-3 col-md-4 control-label"><?php __('opt_o_reminder_enable') ?></label>

									<div class="col-lg-9 col-md-8">
										<div class="switch m-t-xs">
											<div class="onoffswitch onoffswitch-data">
												<input type="checkbox" class="onoffswitch-checkbox" id="switch_o_reminder_enable" name="o_reminder_enable" <?php echo $tpl['option_arr']['o_reminder_enable'] == 'Yes' ? ' checked="checked"' : NULL;?>>
												<label class="onoffswitch-label" for="switch_o_reminder_enable">
													<span class="onoffswitch-inner" data-on="<?php echo $yesno['T'] ?>" data-off="<?php echo $yesno['F'] ?>"></span>
													<span class="onoffswitch-switch"></span>
												</label>
											</div>
										</div>
										<input type="hidden" name="value-enum-o_reminder_enable" value="<?php echo 'Yes|No::' . $tpl['option_arr']['o_reminder_enable'];?>">
									</div>
								</div>
								...
								<div class="form-group boxReminder">
									...
									<div class="col-lg-9 col-md-8">
										...
										{
											?>
											<div class="pj-multilang-wrap<?php echo $tpl['is_flag_ready'] ? ' input-group' : NULL;?>" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
												<input type="text" name="i18n[<?php echo $v['id']; ?>][o_reminder_subject]" class="form-control" value="<?php echo isset($tpl['arr']['i18n'][$v['id']]['o_reminder_subject']) ? pjSanitize::html($tpl['arr']['i18n'][$v['id']]['o_reminder_subject']) : ''; ?>" />
												<?php if ($tpl['is_flag_ready']) : ?>
								...
								<div class="form-group boxReminder">
									...
									<div class="col-lg-9 col-md-8 mce-md">
										...
										foreach ($tpl['lp_arr'] as $v)
										{
											?>
											<div class="pj-multilang-wrap<?php echo $tpl['is_flag_ready'] ? ' input-group' : NULL;?>" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
												<textarea name="i18n[<?php echo $v['id']; ?>][o_reminder_body]" class="form-control mceEditor" style="width: 400px; height: 260px;"><?php echo isset($tpl['arr']['i18n'][$v['id']]['o_reminder_body']) && !empty($tpl['arr']['i18n'][$v['id']]['o_reminder_body']) ? htmlspecialchars(stripslashes($tpl['arr']['i18n'][$v['id']]['o_reminder_body'])) : ''; ?></textarea>
												<?php if ($tpl['is_flag_ready']) : ?>
												<span class="input-group-addon pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="<?php echo pjSanitize::html($v['name']); ?>"></span>
												<?php endif; ?>
											</div>
						...
						<div class="row">
							<div class="col-lg-8">
								...
								<div class="form-group">
									<label class="col-lg-3 col-md-4 control-label" for="o_reminder_enable_sms"><?php __('opt_o_reminder_enable_sms') ?></label>

									<div class="col-lg-9 col-md-8">
										<div class="switch m-t-xs">
											<div class="onoffswitch onoffswitch-data">
												<input type="checkbox" class="onoffswitch-checkbox" id="o_reminder_enable_sms" name="o_reminder_enable_sms" <?php echo $tpl['option_arr']['o_reminder_enable_sms'] == 'Yes' ? ' checked="checked"' : NULL;?>>
												<label class="onoffswitch-label" for="o_reminder_enable_sms">
													<span class="onoffswitch-inner" data-on="<?php echo $yesno['T'] ?>" data-off="<?php echo $yesno['F'] ?>"></span>
													<span class="onoffswitch-switch"></span>
												</label>
											</div>
										</div>
										<input type="hidden" name="value-enum-o_reminder_enable_sms" value="<?php echo 'Yes|No::' . $tpl['option_arr']['o_reminder_enable_sms'];?>">
									</div>
								</div>
									...
									<div class="col-lg-9 col-md-8">
										...
										foreach ($tpl['lp_arr'] as $v)
										{
											...
											<div class="<?php echo $tpl['is_flag_ready'] ? 'input-group ' : NULL;?>pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
												<textarea name="i18n[<?php echo $v['id']; ?>][o_reminder_sms_message]" class="form-control" rows="10"><?php echo isset($tpl['arr']['i18n'][$v['id']]['o_reminder_sms_message']) && !empty($tpl['arr']['i18n'][$v['id']]['o_reminder_sms_message']) ? htmlspecialchars(stripslashes($tpl['arr']['i18n'][$v['id']]['o_reminder_sms_message'])) : ''; ?></textarea>
												<?php if ($tpl['is_flag_ready']) : ?>
												<span class="input-group-addon pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="<?php echo pjSanitize::html($v['name']); ?>"></span>
												<?php endif; ?>
											</div>
							...
							<div class="col-lg-4 boxReminderSms">
								...
								<div class="row">
									<?php echo __('opt_o_reminder_sms_message_text') ?>
								</div>
							</div>
						</div>
