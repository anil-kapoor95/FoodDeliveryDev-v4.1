<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12">
		<h2><?php __('infoOrderFormTitle') ?></h2>
        <p class="m-b-none"><i class="fa fa-info-circle"></i><?php __('infoOrderFormDesc') ?></p>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="tabs-container tabs-reservations m-b-l">
        	<ul class="nav nav-tabs">
                <li class="active"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminOptions&amp;action=pjActionOrderForm"><?php __('menuOrderForm'); ?></a></li>
                <li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminOptions&amp;action=pjActionDeliveryForm"><?php __('menuDeliveryForm'); ?></a></li>
            </ul>
                    ...
                    <div class="panel-body">
        				...
        				if (isset($tpl['arr']) && is_array($tpl['arr']) && !empty($tpl['arr']))
        				{
                            ...
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminOptions&amp;action=pjActionUpdate" method="post" id="frmUpdateOptions">
                                ...
                                <input type="hidden" name="next_action" value="pjActionOrderForm" />
