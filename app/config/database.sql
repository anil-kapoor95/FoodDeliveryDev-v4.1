...
CREATE TABLE IF NOT EXISTS `food_delivery_orders` (
  ...
  `price_packing` decimal(16,2) UNSIGNED NULL,
  `price_delivery` decimal(16,2) unsigned DEFAULT NULL,
  `discount` decimal(16,2) unsigned DEFAULT NULL,
  `subtotal` decimal(16,2) unsigned DEFAULT NULL,
  `tax` decimal(16,2) unsigned default NULL,
  `total` decimal(16,2) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `food_delivery_prices` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `location_id` int(10) unsigned DEFAULT NULL,
  `total_from` decimal(16,2) unsigned DEFAULT NULL,
  `total_to` decimal(16,2) unsigned DEFAULT NULL,
  `price` decimal(16,2) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `location_id` (`location_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `food_delivery_categories` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `order` int(10) unsigned DEFAULT NULL,
  `packing_fee` decimal(16,2) UNSIGNED NULL,
...
(1, 'o_allow_order_type', 2, 'both|pickup|delivery::both', 'Pickup and Delivery|Pickup|Delivery', 'enum', 1, 1, NULL),
...
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Automated messages are sent both to client and administrator on specific events. Select message type to edit it - enable/disable or just change message text. For SMS notifications you need to enable SMS service', 'script');
...
INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'gridTotalPrefix', 'backend', 'Grid / of', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'of', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'gridTotalSuffix', 'backend', 'Grid / total', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'total', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'gridShow', 'backend', 'Grid / Show', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Show', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'gridEmptyDate', 'backend', 'Grid / (empty date)', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', '(empty date)', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'gridInvalidDate', 'backend', 'Grid / (invalid date)', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', '(invalid date)', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'enum_arr_ARRAY_confirmed', 'backend', 'enum_arr_ARRAY_confirmed', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Confirmed', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'enum_arr_ARRAY_pending', 'backend', 'enum_arr_ARRAY_pending', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Pending', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'enum_arr_ARRAY_cancelled', 'backend', 'enum_arr_ARRAY_cancelled', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Cancelled', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'enum_arr_ARRAY_1', 'backend', 'enum_arr_ARRAY_1', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'No', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'enum_arr_ARRAY_2', 'backend', 'enum_arr_ARRAY_2', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Yes', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'enum_arr_ARRAY_3', 'backend', 'enum_arr_ARRAY_3', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Yes (required)', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'pjBaseBackup_pjActionAutoBackup', 'backend', 'Cron job name auto backup', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Create automatic back-ups for database and files', 'script');
...
ON DUPLICATE KEY UPDATE `food_delivery_plugin_base_fields`.`type` = 'backend', `label` = @label, `source` = 'plugin', `modified` = NULL;

SET @content := 'Packing fee';

INSERT INTO `food_delivery_plugin_base_multi_lang` (`id`, `foreign_id`, `model`, `locale`, `field`, `content`, `source`)
SELECT NULL, `id`, 'pjBaseField', '::LOCALE::', 'title', @content, 'plugin'
FROM `food_delivery_plugin_base_fields` WHERE `key` = 'lblCategoryPackingFee'
ON DUPLICATE KEY UPDATE `food_delivery_plugin_base_multi_lang`.`content` = @content, `source` = 'plugin';
...
INSERT INTO `food_delivery_plugin_base_multi_lang` (`id`, `foreign_id`, `model`, `locale`, `field`, `content`, `source`)
SELECT NULL, `id`, 'pjBaseField', '::LOCALE::', 'title', @content, 'plugin'
FROM `food_delivery_plugin_base_fields` WHERE `key` = 'lblPacking'
ON DUPLICATE KEY UPDATE `food_delivery_plugin_base_multi_lang`.`content` = @content, `source` = 'plugin';
...
ON DUPLICATE KEY UPDATE `food_delivery_plugin_base_fields`.`type` = 'frontend', `label` = @label, `source` = 'script', `modified` = NULL;

SET @content := 'Packing fee';

INSERT INTO `food_delivery_plugin_base_multi_lang` (`id`, `foreign_id`, `model`, `locale`, `field`, `content`, `source`)
SELECT NULL, `id`, 'pjBaseField', '::LOCALE::', 'title', @content, 'script'
FROM `food_delivery_plugin_base_fields` WHERE `key` = 'front_packing_fee'
ON DUPLICATE KEY UPDATE `food_delivery_plugin_base_multi_lang`.`content` = @content, `source` = 'script';

SET @label := 'Reports / Packing Fees';

INSERT INTO `food_delivery_plugin_base_fields` (`id`, `key`, `type`, `label`, `source`, `modified`) VALUES
(NULL, 'report_packing_fees', 'backend', @label, 'script', NULL)
ON DUPLICATE KEY UPDATE `food_delivery_plugin_base_fields`.`type` = 'backend', `label` = @label, `source` = 'script', `modified` = NULL;

SET @content := 'Packing fees';

INSERT INTO `food_delivery_plugin_base_multi_lang` (`id`, `foreign_id`, `model`, `locale`, `field`, `content`, `source`)
SELECT NULL, `id`, 'pjBaseField', '::LOCALE::', 'title', @content, 'script'
FROM `food_delivery_plugin_base_fields` WHERE `key` = 'report_packing_fees'
ON DUPLICATE KEY UPDATE `food_delivery_plugin_base_multi_lang`.`content` = @content, `source` = 'script';
...
INSERT INTO `food_delivery_plugin_base_multi_lang` (`id`, `foreign_id`, `model`, `locale`, `field`, `content`, `source`)
SELECT NULL, `id`, 'pjBaseField', '::LOCALE::', 'title', @content, 'script'
FROM `food_delivery_plugin_base_fields` WHERE `key` = 'opt_o_terms_show'
ON DUPLICATE KEY UPDATE `food_delivery_plugin_base_multi_lang`.`content` = @content, `source` = 'script';


INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'price_err_ARRAY_100', 'arrays', 'price_err_ARRAY_100', 'script', '2019-08-26 08:17:13');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'The price cannot be greater than 99999999999999.99.', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'lblNoLocationsFound', 'backend', 'lblNoLocationsFound', 'script', '2020-08-22 12:38:30');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'No location found. Add a location', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'lblProductStatus', 'backend', 'lblProductStatus', 'script', '2020-08-22 12:38:30');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Status', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'product_statues_ARRAY_T', 'arrays', 'product_statues_ARRAY_T', 'script', '2020-08-22 12:38:30');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Active', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'product_statues_ARRAY_F', 'arrays', 'product_statues_ARRAY_F', 'script', '2020-08-22 12:38:30');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Inactive', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'opt_o_allow_order_type', 'backend', 'opt_o_allow_order_type', 'script', '2020-08-22 12:38:30');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Allow pickup/delivery', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'enum_arr_ARRAY_both', 'arrays', 'enum_arr_ARRAY_both', 'script', '2020-08-22 12:38:30');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Both', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'enum_arr_ARRAY_pickup', 'arrays', 'enum_arr_ARRAY_pickup', 'script', '2020-08-22 12:38:30');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Pickup', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'enum_arr_ARRAY_delivery', 'arrays', 'enum_arr_ARRAY_delivery', 'script', '2020-08-22 12:38:30');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Delivery', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'order_statuses_ARRAY_prepared', 'arrays', 'order_statuses_ARRAY_prepared', 'script', '2020-08-22 12:38:30');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Prepared', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'order_statuses_ARRAY_out_for_delivery', 'arrays', 'order_statuses_ARRAY_out_for_delivery', 'script', '2020-08-22 12:38:30');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Out for delivery', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'order_statuses_ARRAY_delivered', 'arrays', 'order_statuses_ARRAY_delivered', 'script', '2020-08-22 12:38:30');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Delivered', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'order_statuses_ARRAY_ready_to_pickup', 'arrays', 'order_statuses_ARRAY_ready_to_pickup', 'script', '2020-08-22 12:38:30');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Ready to pickup', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'order_statuses_ARRAY_picked_up', 'arrays', 'order_statuses_ARRAY_picked_up', 'script', '2020-08-22 12:38:30');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Picked up', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'lblOrderCompleted', 'backend', 'Label / Completed', 'script', '2020-08-22 12:38:30');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Completed', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'menuNewOrders', 'backend', 'Menu / New Orders', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'New Orders', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'infoNewOrdersListTitle', 'backend', 'Info / Latest Orders', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Latest Orders', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'infoNewOrdersListDesc', 'backend', 'Info / New Orders List Desc', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'See a list of all active orders. You can update statuses of the orders and marked them as completed. Click on the aye icon of each entry to view order details', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'menuLatestOrders', 'backend', 'Menu / Latest Orders', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Latest Orders', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'menuOrdersList', 'backend', 'Menu / Orders List', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Orders List', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'lblOrderedProducts', 'backend', 'Label / Products', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Products', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'btnClose', 'backend', 'Button / Close', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Close', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'lblOrderNotFound', 'backend', 'Info / Order not found!', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Order not found!', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'lblOrderExtras', 'backend', 'Label / Extras', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Extras', 'script');



SET @level_1_id := (SELECT `id` FROM `food_delivery_plugin_auth_permissions` WHERE `key`='pjAdminOrders');

  INSERT INTO `food_delivery_plugin_auth_permissions` (`id`, `parent_id`, `key`) VALUES (NULL, @level_1_id, 'pjAdminOrders_pjActionNewOrders');
  SET @level_2_id := (SELECT LAST_INSERT_ID());

    INSERT INTO `food_delivery_plugin_auth_permissions` (`id`, `parent_id`, `key`) VALUES (NULL, @level_2_id, 'pjAdminOrders_pjActionUpdateNewOrder');


INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'pjAdminOrders_pjActionNewOrders', 'backend', 'pjAdminOrders_pjActionNewOrders', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'New orders', 'script');

INSERT INTO `food_delivery_plugin_base_fields` VALUES (NULL, 'pjAdminOrders_pjActionSaveNewOrder', 'backend', 'pjAdminOrders_pjActionSaveNewOrder', 'script', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `food_delivery_plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'Update status of new order', 'script');




UPDATE `food_delivery_plugin_auth_permissions` SET `key`='pjPayments_pjActionIndex' WHERE `key`='pjAdminOptions_pjActionPayments';
UPDATE `food_delivery_plugin_base_fields` SET `key`='pjPayments_pjActionIndex' WHERE `key`='pjAdminOptions_pjActionPayments';
